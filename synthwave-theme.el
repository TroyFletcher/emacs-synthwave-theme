...
(let* (
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-clocking ((,class (:weight bold :foreground "black" :background ,synth-gold))))
   `(org-agenda-column-dateline ((,class ,column)))
   `(org-agenda-current-time ((,class (:underline t :weight bold :foreground ,synth-lighter-blue))))
   ...
   `(org-mode-line-clock ((,class (:box (:line-width 1 :color ,synth-pink) :foreground ,near-black :background ,synth-gold))))
   `(org-mode-line-clock-overrun ((,class (:weight bold :box (:line-width 1 :color ,synth-deep-red) :foreground ,near-black :background "red"))))
   ...
   `(org-scheduled ((,class (:foreground ,synth-pale-cyan))))
   `(org-scheduled-previously ((,class (:foreground "black" :background ,synth-pink))))
