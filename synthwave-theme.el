...
(let* (
  ...
  (custom-theme-set-faces
   ...
   `(org-clock-overlay ((,class (:foreground ,near-near-black :background ,synth-light-gold))))
   ...
   `(org-mode-line-clock ((,class (:box (:line-width 1 :color ,synth-deep-purple) :foreground ,near-near-black :background ,synth-light-gold))))
